using FashionClubECommerce.DataAccess.Concrete.Contexts.EntityFramework.Mappings;
using FashionClubECommerce.Entities.Concrete;
using Microsoft.EntityFrameworkCore;

namespace FashionClubECommerce.DataAccess.Concrete.Contexts.EntityFramework
{
    ...
    public class FashionContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=TOSHIBA\SQLEXPRESS;Database=FashionClub;TrustServerCertificate=true;MultipleActiveResultSets=true;");
        }
