...
using FashionClubECommerce.DataAccess.Concrete.Repositories.EntityRepo;

namespace FashionClubECommerce.DataAccess.Concrete
{
    public class UnitOfWorks : IUnitOfWorks
    {
        ...
        public ICustomersRepository CustomersRepository => customer ?? new CustomersRepository(context);
